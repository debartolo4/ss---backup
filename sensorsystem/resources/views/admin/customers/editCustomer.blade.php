        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Modifica azienda cliente</div>
                    <div class="panel-body">
                        {!!Form::open(['class' => 'form-horizontal', 'action' => ['CustomerController@update', $customer->id], 'method' => 'PUT'])!!}
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('partita_IVA') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="partita_IVA" type="text" class="form-control" name="partita_IVA" value="{{$customer->partita_IVA}}" required autofocus>
