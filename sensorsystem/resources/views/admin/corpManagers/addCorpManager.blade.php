        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Registra un nuovo Responsabile aziendale</div>

                    <div class="panel-body">
                        {!!Form::open(['class' => 'form-horizontal', 'action' => 'CorpmanagerController@store', 'method' => 'POST'])!!}
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('CF') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="CF" type="CF" class="form-control" name="CF" value="{{ old('CF') }}" required>
